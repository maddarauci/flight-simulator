...
/*
heres a cpp spaceship class. the ship is represented with position,  orientation and current speed and 
it is independent of OpenGL
*/
...
inline void Ship::yaw(double angle) {
	right = unit(righ * cos(angle) + forward * sin(angle));
